Overview
========
The Hello Boot demo application provides a sanity check for the new SDK build environments and board bring up. The Hello
Boot demo prints the "Hello Boot" string to the terminal using the SDK UART drivers. The purpose of this demo is to
